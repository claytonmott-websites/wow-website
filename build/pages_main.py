...
def home():
    paths = [
        ("Taxi owners", "Earn fuel rebates, see your fleet on screen and turn trips into bankable records.", "who-its-for.html#owners"),
    ...
    path_cards += f'<a class="card path" href="get-involved.html" style="background:var(--red);color:#fff"><h3>Not sure where you fit?</h3><p style="color:#fff">Tell us who you are and we’ll point you to the right team.</p><span class="more" style="color:#fff">Get in touch{ic("arrow")}</span></a>'
...
<section class="hero" aria-labelledby="hero-title">
  <div class="wrap hero-grid">
    <div class="hero-copy">
      ...
      <p class="lead">WOW is South Africa’s largest collectively owned public transport structure: one wallet, ten focus areas, and a digital platform the taxi industry owns outright.</p>
    ...
    <div class="hero-media">
      {photo(R, "WOW_Photo_Owner-Golden-Hour.jpg", "A taxi owner in a WOW jacket at the rank at sunset, holding his phone", "#Siyabangena").replace('loading="lazy"', 'fetchpriority="high"')}
      <div class="hero-card"><b class="num">~67 000</b><span>taxi operators, organised as one</span></div>
    </div>
  </div>
</section>

<section class="sec tight" aria-label="WOW in numbers" style="padding-top:0">
  <div class="wrap">{stats([("~105 000", "Minibus taxis on the network"), ("~1/3", "Of South Africa’s national fleet"), ("120 000+", "Scholars transported every school day"), ("186 / 45", "Primary and secondary co-operatives")])}</div>
</section>
...
<section class="sec" aria-labelledby="why-title">
  <div class="wrap split">
    {photo(R, "WOW_Photo_Agent-At-The-Rank.jpg", "A WOW Agent helps a driver at the taxi rank", "WOW Agents at every rank", "tar")}
...
<section class="sec red-bg siya" aria-labelledby="siya-title">
  ...
  <div class="wrap siya-grid">
    ...
    <div style="display:grid;gap:22px;justify-items:start">
      <p>You <i>ngena</i> a taxi when you board it. Siyabangena is the taxi industry entering the digital economy on its own terms, with confidence and intent. And this time, everyone gets in.</p>
...
<section class="sec" aria-labelledby="awards-title">
  <div class="wrap">
    ...
    <div class="grid2">
      ...
      <article class="award"><span class="yr">42nd Southern African Transport Conference · 2024</span>{tab("Winner", "red")}<h3>Best Exhibition Stand</h3><p>The first time a taxi industry solution has won this award.</p></article>
    </div>
  </div>
</section>
""" + cta_band(R)
    return page(R, "home", "WOW — Wealth on Wheels · Crafted and owned by the public transport industry",
                "WOW is South Africa’s industry-owned digital operating system for the minibus taxi economy: one wallet, ten focus areas, owned by the co-operative.", body)


# ------------------------------------------------------------------ WHY WOW
def why():
    principles = [
        ("A territory larger than England", "The cohesion spans the entire Eastern Cape (minibus taxis, buses, e-hailing and township deliveries), a formal co-operative structure that exists in no other province."),
    ...
    body = page_hero(R, "Why WOW", 'The asset others <span class="hl">cannot replicate.</span>',
                     ...
                     [("Why WOW", None)], aside=photo(R, "WOW_Photo_Field-Operations.jpg", "WOW field operations team checking taxis at the rank", "Organised from within", "tar"))
    body += f"""
...
<section class="sec" id="structure" aria-labelledby="structure-title">
  ...
  <div class="wrap" style="margin-top:64px">{stats([("~67 000", "Operators represented"), ("~105 000", "Minibus taxis"), ("~15 000", "E-hailing vehicles"), ("~1/3", "Of the national fleet")])}</div>
</section>
...
<section class="sec chalk" id="from-within" aria-labelledby="within-title">
  <div class="wrap">
    <div class="sec-head"><span class="eyebrow">Organised from within</span><h2 class="h2" id="within-title">Built with the industry, not imposed on it.</h2>
      <p class="lead">The minibus taxi economy has long resisted structures imposed from outside. Many technology projects failed because they tried to digitise the industry before understanding how it is organised. ECTTC did the opposite.</p></div>
...
<section class="sec red-bg siya" id="siyabangena" aria-labelledby="siya-title">
  ...
  <div class="wrap siya-grid" style="align-items:start">
    ...
    <div class="prose" style="display:grid;gap:18px">
      ...
      <p style="color:#fff">The root verb <i>-ngena</i>, “to enter”, is the everyday verb of taxi life. You <i>ngena</i> a taxi when you board it. Because <i>ukungena</i> is shared across the Nguni languages, it reads instantly in isiZulu and isiXhosa alike.</p>
      <p style="color:#fff">That’s why it sits beneath the logo. WOW is the taxi industry entering the digital economy on its own terms, in payments, connectivity and technology. Siyabangena: we’re getting in. And this time, everyone gets in.</p>
    </div>
  </div>
</section>
...
<section class="sec chalk" id="destination" aria-labelledby="dest-title">
  <div class="wrap split">
    <div style="display:grid;gap:22px;justify-items:start">
      ...
      <p class="lead">Taxis, buses, e-hailing, scholar transport and township delivery on one Integrated Public Transport Management System, unlocking prosperity through digitalisation.</p>
    ...
    {photo(R, "WOW_Photo_Commuter-Cashless-Payment.jpg", "A commuter pays her fare by phone at the taxi window", "One wallet across the journey", "green")}
  </div>
</section>
""" + cta_band(R)
